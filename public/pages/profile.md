...
- Developing custom components from scratch and enhancement of existing components for Decathlon.com.tr
- Frontend development of in-house web applications with React.js/Next.js, Gatsby and Svelte JS
- Implementation of A/B test variations (Statsig) alongside the UI/UX designer
- Implementation of optimized components/code in accordance with Eco-Design principles
- Ensuring development results are communicated to other teams using technologies like Google Analytics (GA4), GTM
- Managing and monitoring CI/CD (Git Actions, AWS, Gcloud, Kubernetes) processes
- **Technologies:** React.js, Svelte JS, JavaScript, Node.js, Next.js, SASS/LESS, SEO, A/B Testing
