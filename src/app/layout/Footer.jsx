      ...
      <Grid container>
        ...
        <Grid item sx={{ backgroundColor: "#3279CB", width: "200px" }} display="flex">
          <Stack direction="row" spacing={0.5} sx={{ pl: 1 }}>
            <Box
              component={Link}
              href="https://github.com/basarballioz"
              underline="none"
              color="white"
              target="_blank"
              display="flex"
            ...
            >
              ...
              <Typography sx={{ ml: 0.5, mt: 0.1, fontSize: "0.6rem" }}>development</Typography>
            </Box>

            <Stack
              direction="row"
              spacing={0.5}
              sx={{ px: 0.5, cursor: "pointer", "&:hover": { background: "#1f8ad2" } }}
            >
